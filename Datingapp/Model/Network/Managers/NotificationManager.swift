...
class NotificationManager{
    ...
    func getNotifications(AccessToken:String,Limit:Int,Offset:Int, completionBlock: @escaping (_ Success:NotificationModel.NotificationSuccessModel?,_ SessionError:NotificationModel.sessionErrorModel?, Error?) ->()){
