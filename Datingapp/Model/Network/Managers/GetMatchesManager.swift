...
class GetMatchesManager{
    ...
    func getMatches(AccessToken:String,Limit:Int,Offset:Int,genders:String, completionBlock: @escaping (_ Success:GetMatchModel.GetMatchSuccessModel?,_ SessionError:GetMatchModel.sessionErrorModel?, Error?) ->()){
        let params = [
        ...
        log.verbose("Targeted URL = \(API.USERS_CONSTANT_METHODS.RANDOM_USER_API)")
